...
7. Foi criado uma action nesse repositório para copiar o codigo da aplicação() para o AWS S3(s3://landing-jaime/app/), apara o AWS EMR possa executa-la.Caso haja alteração na aplicação as proxima execuções do ERM já irão refletir as alterações.
8. Foi utiizado o notebook abaixo para realiza o processamento dos dados.
